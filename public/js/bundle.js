...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXl1c2g0NTYiLCJhIjoiY2wxaDd4aGltMHZhbzNqcDN2b25lczFyNCJ9.79uyDs_g1ruDP7wbwK_Rkw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/ayush456/cl1h8l6yd001h15nq9z6jqpor',
    // style URL
    scrollZoom: false
  });
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bounds to include current location coordinates
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)(res.data.status, "Updated Profile ".concat(type.toUpperCase(), " Successfully!"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KsreKJeVPqBszZjTonGLtx3xLzFS59mDESiVct8p1kquCcH8dO5WFLif6ScOMLO9KY0FNB7sbsv5JRgPQ5jCmRI00eJPyeIvL');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'GET',
